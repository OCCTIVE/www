...
function AboutPage() {
  return (
    <section className="about-page">
      ...
      <section className="about-section about-section--lead">
        <div className="about-two-col">
          <div className="about-two-col-main">
            <h2 className="about-section-title about-section-title--compact">Project Abstract</h2>
        ...
        <div className="about-leadership-wrapper">
          ...
          <table className="about-leadership-table">
            ...
            <tbody>
              ...
              <tr><td>Melvyn Tan</td><td>Web Developer</td><td>UC San Diego</td></tr>
              <tr><td>Tanvi Vidyala</td><td>Web Developer</td><td>UC San Diego</td></tr>
              <tr><td>Nicole Go</td><td>Web Developer</td><td>UC San Diego</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      {/* NSF Grant Info */}
      <section className="about-section about-section--flush-top">
